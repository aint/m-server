...
public class TrackerSettingsServiceImpl implements TrackerSettingsService {

    private static final Logger logger = LoggerFactory.getLogger(TrackerSettingsServiceImpl.class);
    ...
    @Autowired
    public TrackerSettingsServiceImpl(SupervisorEndpoint supervisorEndpoint, Environment env) {
